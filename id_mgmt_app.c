...
//Main ID management Library function which accepts user input for create, delete, query and show the nodes in the database
//Also it has a function to release inactive nodes in the database
